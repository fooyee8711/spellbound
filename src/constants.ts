...
export const WORDS: Word[] = [
  ...
  },
  {
    ...
    target: "rummage",
    translation: "翻找",
    originalSentence: "He was busy rummaging in his cloak, looking for something.",
    sceneDescription: "Albus Dumbledore was rummaging through his cloak to find his Put-Outer when he arrived at Privet Drive."
  },
  {
    id: "8",
    target: "slither",
    translation: "滑行",
    originalSentence: "Behind the glass, all sorts of lizards and snakes were crawling and slithering over bits of wood and stone.",
    sceneDescription: "Various snakes and lizards were slithering over rocks and wood inside the reptile house."
  },
  {
    id: "9",
    target: "dash",
  ...
  },
  {
    ...
    target: "peculiar",
    translation: "古怪的、奇怪的",
    originalSentence: "It was on the corner of the street that he noticed the first sign of something peculiar – a cat reading a map.",
    sceneDescription: "Uncle Vernon noticed a peculiar sight of a tabby cat reading a map on the corner of Privet Drive."
  },
  {
    id: "13",
    target: "enraged",
    translation: "暴怒的、被激怒的",
    originalSentence: "Mr Dursley was enraged to see that a couple of them weren’t young at all; why, that man had to be older than he was, and wearing an emerald-green cloak!",
    sceneDescription: "Uncle Vernon was enraged by the sight of oddly dressed adults wearing cloaks in the street."
  },
  {
    id: "14",
    target: "frantic",
  ...
  },
  {
    ...
    originalSentence: "Hagrid ran his fingers through his hair, fixing Harry with a bewildered stare.",
    sceneDescription: "Hagrid gave Harry a bewildered stare when he realized Harry knew nothing about magic or his parents."
  },
  {
    id: "17",
    target: "petrified",
  ...
  },
  {
    ...
    target: "corridor",
    translation: "走廊、通道",
    originalSentence: "They flitted along corridors striped with bars of moonlight from the high windows.",
    sceneDescription: "Harry and his friends quietly hurried along the moonlit corridors of the castle to avoid Filch."
  },
  {
    id: "26",
    target: "hinges",
  ...
  },
  {
    ...
    target: "promptly",
    translation: "迅速地、立刻",
    originalSentence: "Harry and Dudley promptly had a furious but silent fight over who would listen at the keyhole...",
    sceneDescription: "Harry and Dudley promptly started fighting over who would get to eavesdrop at the keyhole."
  },
  {
    id: "30",
    target: "distinctly",
